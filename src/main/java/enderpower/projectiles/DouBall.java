...
public class DouBall extends EntityThrowable{
	...
	public DouBall(World world, EntityLivingBase livingbase) {
	...
	protected void onImpact(MovingObjectPosition var1) {
		if(var1.entityHit != null){
			var1.entityHit.attackEntityFrom(DamageSource.causePlayerDamage((EntityPlayer) this.getThrower()), 5.0F);
		}
	}
